                ...
                {isDefaultFolder && (
                  ...
                  >
                    ...
                    <Typography.Paragraph>
                      ...
                      Система поддерживает все HTTP методы (GET, POST, PUT, DELETE, PATCH, HEAD, OPTIONS), умные заголовки (обязательные/необязательные),
                      проверку содержимого тела запроса, историю всех запросов, метрики Prometheus и логирование в JSON формате.
                    </Typography.Paragraph>

                    <Typography.Title level={4}>Базовый сценарий работы</Typography.Title>
                    ...
                    <Typography.Title level={4} style={{ marginTop: 16 }}>Управление папками и подпапками</Typography.Title>
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      <ul style={{ paddingLeft: 18, lineHeight: 1.6, margin: 0 }}>
                        <li><b>Создание папок</b> — используйте кнопку «Создать страницу» для создания новой папки. Можно создавать как корневые папки,
                            так и подпапки, указав родительскую папку при создании. Папки позволяют логически организовать моки по проектам, модулям или сценариям.</li>
                        <li><b>Иерархическая структура</b> — система поддерживает многоуровневую иерархию папок. Подпапки отображаются с отступом и могут быть развёрнуты/свёрнуты.
                            Каждая папка имеет свой уникальный базовый URL для доступа к мокам.</li>
                        <li><b>Упорядочивание папок</b> — папки можно перетаскивать (drag-and-drop) для изменения порядка отображения. Порядок сохраняется автоматически.</li>
                        <li><b>Поиск по папкам</b> — используйте поле поиска над списком папок для быстрого поиска по имени папки или подпапки.</li>
                        <li><b>Переименование папок</b> — нажмите на иконку редактирования рядом с папкой для переименования. Переименование не влияет на уже созданные моки.</li>
                        <li><b>Дублирование папок</b> — кнопка «Дублировать страницу» позволяет скопировать всю папку со всеми моками и настройками.
                            Все моки копируются с новыми идентификаторами, но сохраняют свои настройки.</li>
                        <li><b>Удаление папок</b> — при удалении папки автоматически удаляются все моки и подпапки внутри неё. Папка "Главная" (default) удалению не подлежит.</li>
                        <li><b>Настройки папки</b> — каждая папка может иметь свои настройки прокси. Настройте прокси-режим для папки через кнопку «Настройки proxy»,
                            чтобы запросы без моков автоматически проксировались на реальный backend.</li>
                      </ul>
                    </Typography.Paragraph>

                    <Typography.Title level={4} style={{ marginTop: 16 }}>Импорт и экспорт данных</Typography.Title>
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      <ul style={{ paddingLeft: 18, lineHeight: 1.6, margin: 0 }}>
                        <li><b>Импорт из curl команд</b> — в форме создания/редактирования мока есть поле «Импорт из curl».
                            ...
                            извлечёт метод, URL, заголовки и тело запроса. Поддерживаются все популярные форматы curl, включая
                            команды с базовой аутентификацией, файлами и сложными заголовками.</li>
                        <li><b>Импорт из Postman Collection</b> — используйте кнопку «Импорт» для загрузки Postman Collection v2.1.
                            При импорте можно выбрать существующую папку или создать новую папку прямо в процессе импорта.
                            Система автоматически создаст моки по всем запросам из коллекции, включая примеры ответов, переменные окружения
                            и пред-скрипты. Поддерживается импорт из коллекций любой сложности.</li>
                        <li><b>Импорт из OpenAPI/Swagger</b> — нажмите кнопку «Импорт OpenAPI/Swagger» в верхней панели. Вставьте URL до спецификации
                            (JSON или YAML) или загрузите файл. При импорте можно выбрать существующую папку или создать новую папку/подпапку.
                            Система поддерживает <b>OpenAPI 3.x</b> и <b>Swagger 2.0</b> форматы. Автоматически извлекаются примеры запросов и ответов
                            из спецификации. Если примеры не указаны явно, система генерирует их из схем (JSON Schema), создавая готовые моки
                            с реалистичными данными для всех эндпоинтов. Поддерживаются все типы операций (GET, POST, PUT, DELETE, PATCH и т.д.)
                            с учётом параметров пути, query-параметров и тел запросов.</li>
                        <li><b>Экспорт curl</b> — для любого мока можно скопировать готовую curl команду, нажав кнопку «Скопировать curl»
                            в таблице моков. Команда будет корректно сформирована с учётом метода, заголовков и тела запроса, включая
                            правильное кодирование специальных символов.</li>
                        <li><b>Экспорт папки</b> — используйте кнопку «Экспорт» для экспорта всех моков из текущей папки. Экспортированные
                            данные можно использовать для резервного копирования или переноса моков между инстансами системы.</li>
                      </ul>
                    </Typography.Paragraph>
                    <Typography.Paragraph type="secondary" style={{ marginTop: 8 }}>
                      <b>Советы по импорту:</b> Создавайте отдельную папку под каждую большую спецификацию или коллекцию для лучшей организации.
                      При импорте OpenAPI/Swagger можно указать имя спецификации — оно будет сохранено для дальнейшего использования.
                      Используйте подпапки для группировки моков внутри большой коллекции по логическим модулям.
                    </Typography.Paragraph>
...
{`"__error_simulation__": {
  ...
  "body": {"error": "Not Found", "path": "` + "{path}" + `"}
                    ...
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      <ul style={{ paddingLeft: 18, lineHeight: 1.6, margin: 0 }}>
                        <li><b>Прокси-режим</b> настраивается для каждой страницы через кнопку «Настройки proxy»:
                            ...
                            запрос будет автоматически проксирован туда. Это позволяет постепенно заменять реальные запросы
                            на моки, создавая их по мере необходимости.</li>
                        <li><b>Генерация моков из проксированных запросов</b> — одна из самых мощных функций системы.
                            Когда запрос проксируется на реальный backend, система сохраняет полную информацию о запросе и ответе
                            в истории вызовов. Для любого проксированного запроса в таблице истории доступна кнопка «Сформировать мок».
                            При нажатии система автоматически создаст мок на основе реального запроса и ответа, включая:
                            <ul style={{ paddingLeft: 20, marginTop: 8 }}>
                              <li>HTTP метод и путь запроса</li>
                              <li>Заголовки запроса (системные заголовки автоматически фильтруются)</li>
                              <li>Тело запроса (если было)</li>
                              <li>HTTP статус код ответа</li>
                              <li>Заголовки ответа (системные заголовки автоматически фильтруются)</li>
                              <li>Тело ответа (поддерживаются JSON, текст, бинарные данные и файлы)</li>
                            </ul>
                            Созданный мок автоматически активируется и сохраняется в текущей папке. Это позволяет быстро создавать
                            моки на основе реальных запросов к API, не тратя время на ручное копирование данных. Особенно полезно
                            при работе с большим количеством эндпоинтов или при изучении работы существующего API.</li>
                        ...
                        <li><b>Безопасность</b> — все вызовы UI идут только на указанный в поле «Бэк» адрес и текущий
                            mock-сервер; настройку ограничения размеров и хостов прокси можно считать уже встроенной.
                            Системные заголовки (например, от прокси-серверов, CDN) автоматически фильтруются при генерации моков,
                            чтобы не создавать ложных зависимостей от инфраструктуры.</li>
                      </ul>
                    </Typography.Paragraph>

                    <Typography.Title level={4} style={{ marginTop: 16 }}>Кэширование ответов</Typography.Title>
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      <ul style={{ paddingLeft: 18, lineHeight: 1.6, margin: 0 }}>
                        <li><b>Включение кэширования</b> — в форме создания/редактирования мока есть опция «Включить кэширование ответа»
                            и поле «TTL кэша (сек)». Это удобно для эндпоинтов, где ответ редко меняется и важно тестировать работу клиентов с кэшем.
                            TTL можно задать как через UI, так и через специальное поле <code>__cache_ttl__</code> в теле ответа.</li>
                        <li><b>Как работает кэш</b> — при включённом кэшировании одинаковые запросы (с одинаковыми методом, путём, заголовками и телом)
                            будут обслуживаться из кэша в течение времени TTL без повторной обработки мока. Это ускоряет ответы и снижает нагрузку на сервер.</li>
                        <li><b>Управление кэшем</b> — в таблице моков доступны действия для очистки кэша конкретного мока (кнопка «Кэш»).
                            Также доступны API endpoints: <code>GET /api/cache/status</code> для проверки состояния кэша и
                    ...
                    <Typography.Title level={4} style={{ marginTop: 16 }}>Мониторинг и аналитика</Typography.Title>
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      <ul style={{ paddingLeft: 18, lineHeight: 1.6, margin: 0 }}>
                        <li><b>Детальная история вызовов</b> — система сохраняет информацию о каждом вызове в отдельную запись.
                            Откройте модальное окно метрик через кнопку «Метрики» над таблицей моков. В таблице «Детальная история вызовов» отображается:
                            <ul style={{ paddingLeft: 20, marginTop: 8 }}>
                              <li>Время вызова с точностью до миллисекунд</li>
                              <li>HTTP метод (GET, POST, PUT, DELETE и т.д.)</li>
                              <li>Путь запроса</li>
                              <li>Информация о проксировании (был ли запрос проксирован на реальный backend)</li>
                              <li>Время ответа в миллисекундах</li>
                              <li>TTL кэша (если использовался) с возможностью сброса</li>
                              <li>HTTP статус код ответа</li>
                            </ul>
                            Каждый вызов отображается как отдельная строка с полной информацией, что позволяет отслеживать все запросы к мокам.
                            <b>Важно:</b> Для проксированных запросов в таблице истории доступна кнопка «Сформировать мок», которая позволяет
                            автоматически создать мок на основе реального запроса и ответа. Это особенно удобно при постепенном переходе
                            от реального API к мокам — просто включите прокси-режим, выполните запросы к реальному API, и затем создайте
                            моки из истории вызовов одним кликом. История вызовов может быть очищена через кнопку «Очистить историю» в модальном окне метрик.</li>
                        <li><b>Метрики папки</b> — для каждой папки доступна статистика: общее количество запросов, количество совпадений с моками,
                            количество проксированных запросов, количество симулированных ошибок, количество попаданий в кэш,
                            среднее время ответа и другие показатели. Откройте метрики через кнопку «Метрики» над таблицей моков.</li>
                        <li><b>Глобальные метрики</b> — кнопка «Глобальные метрики» в верхней панели показывает агрегированную статистику
                            по всему сервису, включая все папки и подпапки. Это полезно для общего мониторинга нагрузки и производительности.</li>
                        <li><b>Метрики Prometheus</b> — сервер экспортирует метрики в формате Prometheus по адресу <code>/metrics</code>.
                            Включаются следующие метрики:
                            <ul style={{ paddingLeft: 20, marginTop: 8 }}>
                              <li><code>mockl_requests_total</code> — общее количество запросов (с метками method, path, folder, outcome)</li>
                              <li><code>mockl_mock_hits_total</code> — количество совпадений с моками (по папкам)</li>
                              <li><code>mockl_proxy_requests_total</code> — количество проксированных запросов (по папкам)</li>
                              <li><code>mockl_errors_simulated_total</code> — количество симулированных ошибок (по папкам)</li>
                              <li><code>mockl_cache_hits_total</code> — количество попаданий в кэш (по папкам)</li>
                              <li><code>mockl_response_time_seconds</code> — время ответа (гистограмма, по папкам)</li>
                              <li><code>mockl_rate_limited_total</code> — количество заблокированных запросов из-за rate limiting</li>
                            </ul>
                            Метрики можно интегрировать с системами мониторинга, такими как Grafana, для визуализации и алертинга.</li>
                        <li><b>API метрик</b> — также доступны структурированные метрики через REST API:
                            <code>GET /api/metrics/folder/{'{folder}'}</code> для метрик конкретной папки и
                            <code>GET /api/metrics/global</code> для метрик всего сервиса. Метрики возвращаются в JSON формате.</li>
                        <li><b>Логирование</b> — все события логируются в структурированном JSON формате для удобной интеграции
                            с системами логирования (ELK, Splunk, Loki и др.). Уровень логирования настраивается через переменную окружения.</li>
                      </ul>
                    </Typography.Paragraph>

                    <Typography.Title level={4} style={{ marginTop: 16 }}>Производительность и ограничения</Typography.Title>
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      <ul style={{ paddingLeft: 18, lineHeight: 1.6, margin: 0 }}>
                        <li><b>Rate limiting</b> — система поддерживает ограничение частоты запросов на уровне всего сервера.
                            Настройте через переменные окружения <code>MOCKL_RATE_LIMIT_REQUESTS</code> (количество запросов)
                            и <code>MOCKL_RATE_LIMIT_WINDOW_SECONDS</code> (временное окно). При превышении лимита запросы блокируются
                            с соответствующим HTTP статусом.</li>
                        <li><b>Ограничение размера запросов</b> — можно ограничить максимальный размер тела запроса через переменную
                            <code>MOCKL_MAX_REQUEST_BODY_BYTES</code>. Это защищает от DoS-атак через большие запросы.</li>
                        <li><b>Ограничение прокси-хостов</b> — для безопасности можно ограничить список разрешённых хостов для проксирования
                            через переменную <code>MOCKL_ALLOWED_PROXY_HOSTS</code>. Это предотвращает несанкционированное проксирование
                            на внутренние сервисы.</li>
                        <li><b>Оптимизация работы</b> — система оптимизирована для обработки большого количества моков и запросов.
                            Использование кэширования и правильная организация папок помогает поддерживать высокую производительность.</li>
                      </ul>
                    </Typography.Paragraph>

                    <Typography.Title level={4} style={{ marginTop: 16 }}>Управление моками</Typography.Title>
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      <ul style={{ paddingLeft: 18, lineHeight: 1.6, margin: 0 }}>
                        <li><b>Активация/деактивация</b> — каждый мок может быть активирован или деактивирован через переключатель в таблице.
                            Неактивные моки игнорируются при обработке запросов, но остаются в базе данных. Можно массово деактивировать
                            все моки в папке через соответствующую функцию.</li>
                        <li><b>Редактирование моков</b> — нажмите на мок в таблице или используйте кнопку редактирования для изменения настроек.
                            Все изменения сохраняются немедленно, включая изменения порядка и активации.</li>
                        <li><b>Управление порядком</b> — моки можно перетаскивать в таблице для изменения порядка отображения.
                            Порядок сохраняется автоматически и не меняется при редактировании. Порядок влияет на приоритет сопоставления —
                            если несколько моков подходят под запрос, выбирается первый по порядку.</li>
                        <li><b>Клонирование моков</b> — используйте кнопку «Дублировать» в таблице моков для быстрого
                            создания копии мока с теми же настройками. Клонированный мок автоматически получает имя с суффиксом "copy"
                            и добавляется в конец списка. Затем его можно отредактировать для создания вариаций сценариев.</li>
                        <li><b>Удаление моков</b> — используйте кнопку удаления для удаления ненужных моков. Операция необратима,
                            но можно быстро восстановить мок через дублирование, если он был удалён случайно.</li>
                        <li><b>Поиск моков</b> — используйте поле поиска над таблицей моков для фильтрации по имени.
                            Поиск работает в реальном времени и учитывает только текущую папку.</li>
                        <li><b>Человекочитаемые имена</b> — каждому моку можно присвоить понятное имя для быстрой идентификации в таблице.
                            Если имя не указано, используется путь и метод запроса.</li>
                      </ul>
                    </Typography.Paragraph>

                    <Typography.Title level={4} style={{ marginTop: 16 }}>Условия сопоставления запросов</Typography.Title>
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      <ul style={{ paddingLeft: 18, lineHeight: 1.6, margin: 0 }}>
                        <li><b>HTTP методы</b> — система поддерживает все стандартные HTTP методы: GET, POST, PUT, DELETE, PATCH, HEAD, OPTIONS.
                            Метод должен точно совпадать с методом запроса для срабатывания мока.</li>
                        <li><b>Путь запроса</b> — путь может включать параметры (например, <code>/api/users/{'{id}'}</code>) и query-параметры.
                            Система сопоставляет пути с учётом структуры, но не значений параметров в URL.</li>
                        <li><b>Умные заголовки</b> — при настройке заголовков запроса можно указать, является ли заголовок обязательным
                            или необязательным. Для обязательных заголовков проверяется точное совпадение значения.
                            Для необязательных заголовков (переключатель «Авто») проверяется только наличие заголовка,
                            а его значение игнорируется. Это удобно для заголовков, которые автоматически заполняются клиентом или сервером.</li>
                        <li><b>Проверка тела запроса</b> — можно указать строку, которая должна содержаться в теле запроса.
                            Это полезно для сложных сценариев, когда нужно различать запросы по содержимому JSON.</li>
                        <li><b>Автоматическая нормализация JSON</b> — система автоматически нормализует JSON в запросах и ответах,
                            убирая лишние пробелы и форматирование. Это гарантирует корректное сопоставление моков даже при различиях
                            в форматировании JSON.</li>
                    ...
                    <Typography.Title level={4} style={{ marginTop: 16 }}>Интерфейс и удобство использования</Typography.Title>
                    <Typography.Paragraph style={{ marginBottom: 0 }}>
                      <ul style={{ paddingLeft: 18, lineHeight: 1.6, margin: 0 }}>
                        <li><b>Темная и светлая темы</b> — переключайте тему интерфейса для комфортной работы в любое время суток.
                            Настройка темы сохраняется между сеансами.</li>
                        <li><b>Адаптивный дизайн</b> — интерфейс автоматически адаптируется под размер экрана, обеспечивая
                            удобную работу как на десктопе, так и на планшетах.</li>
                        <li><b>Drag-and-drop</b> — используйте перетаскивание для изменения порядка папок и моков.
                            Порядок сохраняется автоматически и влияет на приоритет сопоставления запросов.</li>
                        <li><b>Поиск и фильтрация</b> — встроенный поиск помогает быстро находить нужные папки и моки
                            в больших коллекциях.</li>
                        <li><b>Валидация форм</b> — все формы имеют встроенную валидацию, которая предупреждает об ошибках
                            до сохранения данных.</li>
                        <li><b>Подтверждения действий</b> — критические операции (удаление, деактивация всех моков) требуют
                            подтверждения для предотвращения случайных действий.</li>
                      </ul>
                    </Typography.Paragraph>
                  </div>
                )}
